              ...
              <div className="single-product">
                <div className="product-img">
                  <img
                    ...
                    src="img/product/feature-product/f-p-1.jpg"
                    alt=""
                  />
            ...
            <div className="col-lg-4 col-md-6">
              <div className="single-product">
                <div className="product-img">
                  <img
                    className="img-fluid w-100"
                    src="img/product/feature-product/f-p-2.jpg"
                    alt=""
                  />
                  <div className="p_icon">
                    <a href="#">
            ...
            <div className="col-lg-4 col-md-6">
              <div className="single-product">
                <div className="product-img">
                  <img
                    className="img-fluid w-100"
                    src="img/product/feature-product/f-p-3.jpg"
                    alt=""
                  />
                  <div className="p_icon">
                    <a href="#">
            ...
            <div className="col-lg-6">
              <div className="new_product">
                ...
                <div className="product-img">
                  <img
                    className="img-fluid"
                    src="img/product/new-product/new-product1.png"
                    alt=""
                  />
                </div>
                <h4>$120.70</h4>
                ...
                <div className="col-lg-6 col-md-6">
                  <div className="single-product">
                    <div className="product-img">
                      <img
                        className="img-fluid w-100"
                        src="img/product/new-product/n1.jpg"
                        alt=""
                      />
                      <div className="p_icon">
                        <a href="#">
                ...
                <div className="col-lg-6 col-md-6">
                  <div className="single-product">
                    <div className="product-img">
                      <img
                        className="img-fluid w-100"
                        src="img/product/new-product/n2.jpg"
                        alt=""
                      />
                      <div className="p_icon">
                        <a href="#">
                ...
                <div className="col-lg-6 col-md-6">
                  <div className="single-product">
                    <div className="product-img">
                      <img
                        className="img-fluid w-100"
                        src="img/product/new-product/n3.jpg"
                        alt=""
                      />
                      <div className="p_icon">
                        <a href="#">
                ...
                <div className="col-lg-6 col-md-6">
                  <div className="single-product">
                    <div className="product-img">
                      <img
                        className="img-fluid w-100"
                        src="img/product/new-product/n4.jpg"
                        alt=""
                      />
                      <div className="p_icon">
                        <a href="#">
            ...
            <div className="col-lg-4 col-md-6">
              <div className="single-blog">
                ...
                <div className="short_details">
                  ...
                  <a className="d-block" href="single-/blog">
                    <h4>
